$(function() {
    ...
    $("#comment-form").validate({
        ...
        submitHandler: function(form) {
            ...
            $.post('/listings/ajax_last_comment', {
                last: lastID,
                movie: movID
            }, function(data) {
                $('.user_comments').append(data);
                $("html,body").animate({
                    scrollTop: $('.user_comments li:last').offset().top - 30
                });
            });
        }
    });
